...
variables in our environment when following a backedge, \todo{continue here... explanation of $\delta$}

\todo{Define unification and explain use in rules}
