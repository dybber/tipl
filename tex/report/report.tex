...
possible value. They should not be confused with \textit{program
  variables}, as these \ldots \todo{more explanation of this here...}
...
over the same finite constructor set \todo{reference courcelle}, there is guaranteed to be
...
The delta function should be defined as follows: \todo{}

\subsection{Backward interpretation}
In the case of backward interpretation, we start with an output which
can originate from one of several terminal nodes in the process tree.
