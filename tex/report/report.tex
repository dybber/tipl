...
% We have two separate difficulties that we have to deal with in order
% to present the semantics. 
...
When the tree is traversed backwards 


% We also have another problem that we have to deal with when
% considering the backwards semantics for the closed process tree. We
% can potentially
