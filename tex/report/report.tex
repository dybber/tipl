...
\hspace{-0.7cm}
  \nfrac{
    \begin{array}{c}
      ...
      \sigma\{xe_\alpha |-> v_1, xe_\beta |-> v_2, x_1 |-> e_1/\sigma, \ldots, x_n |-> e_n/\sigma\} |-_\Gamma t_1 => v_1
    \end{array}
  }{
...
\qquad
  \nfrac{
    \begin{array}{c}
      ...
      \end{array} \\
      e_0/\sigma = \texttt{'}s \\
      \sigma\{xa |-> \texttt{'}s, x_1' |-> e_1/\sigma, \ldots, x_n' |-> e_n/\sigma\} |-_\Gamma t_1 => v_1
    \end{array}
  }{
    \sigma |-_\Gamma \texttt{\textit{\rmfamily gname} $e_0$ $e_1$ $\ldots$ $e_n$} => v_1
  }
...
\begin{figure*}
  ...
  \begin{equation}
    \nfrac{
      ea_1 \neq ea_2 \quad (ea_1\ \#\ ea_2) \not \in \textrm{Tautology} \quad \kappa = \textrm{mkBind}(ea_1, ea_2)
    }{
